...
//            return;
    ...
    void obliczCzasActionPerformed(ActionEvent evt) {
        menu.setTimeResult( (((menu.getTk() - menu.getTp()) * menu.getVolume() * 1.16 * 60) / (menu.getPower1() * menu.getEfficiency1())));
        System.out.println("" + menu.getTimeResult());
        menu.getTimeResultField().setText("" + (format2.format(menu.getTimeResult())));
    }
